...
# For LSTM: reshape to (samples, sequence_length, features)
...
# ---------------------------
# 12. Plot Test Predictions for All Models
# ---------------------------
...
plt.subplot(3,2,2)
plt.plot(y_test, label='True SPI', marker='o')
plt.plot(svr_pred, label='SVR', marker='x')
plt.title('SVR Test Prediction')
plt.xlabel('Test Sample Index')
plt.ylabel('SPI')
plt.legend()
...
plt.subplot(3,2,3)
plt.plot(y_test, label='True SPI', marker='o')
plt.plot(mlp_pred, label='MLP', marker='x')
plt.title('MLP Test Prediction')
plt.xlabel('Test Sample Index')
plt.ylabel('SPI')
plt.legend()
...
plt.subplot(3,2,4)
plt.plot(y_test, label='True SPI', marker='o')
plt.plot(edt_pred, label='EDT', marker='x')
plt.title('EDT Test Prediction')
plt.xlabel('Test Sample Index')
plt.ylabel('SPI')
plt.legend()
...
plt.subplot(3,2,5)
plt.plot(y_test, label='True SPI', marker='o')
plt.plot(rf_pred, label='RF', marker='x')
...
# ---------------------------
# 13. Taylor Diagram for Model Comparison
# ---------------------------
...
# ---------------------------
# 14. Forecast 10 Years (120 Months) into the Future using the Best Model
# ---------------------------
